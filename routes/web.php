...
use App\Http\Controllers\Admin\CrewsCrudController;
...
Route::match(['get','post'], 'cp/gc-test', [GcTestController::class, 'index'])->name('cp.gc-test');
Route::match(['get','post'], 'cp/equipments', [EquipmentCrudController::class, 'index'])
    ->name('cp.equipments')
    ->middleware('auth');
Route::match(['get','post'], 'cp/crews', [CrewsCrudController::class, 'index'])
    ->name('cp.crews')
    ->middleware('auth');
Route::match(['get','post'], 'cp/contacts', [ContactsCrudController::class, 'index'])
    ->name('cp.contacts')
    ->middleware('auth');
Route::match(['get','post'], 'cp/companies', [CompaniesCrudController::class, 'index'])
    ->name('cp.companies')
    ->middleware('auth');
Route::match(['get','post'], 'cp/openingShapes', [OpeningShapesCrudController::class, 'index'])
    ->name('cp.openingShapes')
    ->middleware('auth');
Route::match(['get','post'], 'cp/opening', [OpeningCrudController::class, 'index'])
    ->name('cp.opening')
    ->middleware('auth');
