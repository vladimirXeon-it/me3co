...
class OpeningShapesCrudController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $crud->setTable('opening_shapes');

            // 👉 en v3: PK + nombre de tabla (y respeta minúsculas)
            $crud->setPrimaryKey('id', 'opening_shapes');
            ...
            return view('admin.openings.openingShapes', [
